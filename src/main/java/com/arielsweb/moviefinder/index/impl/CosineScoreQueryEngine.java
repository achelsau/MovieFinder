...
public class CosineScoreQueryEngine implements IQueryEngine {
	...
	/**
	 * whether to normalize the scores or not relative to document length. for
	 * example, if we have a score of 10 for a document that's 100 words, the
	 * score will become 0.1. If the same document has 10 words, the score is
	 * higher: 1.
	 **/
	...
	private void assignQueryWeights(String query, Float[] queryW, String[] queryTokens) {
	 ...
	 */
	private void getScoresForToken(HashMap<Long, ResultInfo> results, IndexEntry indexEntry, Float queryTokenWeight) {
	 ...
	 */
	private List<ResultInfo> getCosineSimilarity(Map<String, Float> queryWeights) throws InvalidQueryException {
	 ...
	 */
	@Override
	public List<ResultInfo> queryIndex(Map<String, Float> queryWeights) throws InvalidQueryException {
